...
class FusedMoEParallelConfig:
    ...
    @property
    def use_torch_all2allv_kernels(self):
        """Use torch.distributed.all_to_all_single backend for EP communication."""
        return self.use_all2all_kernels and self.all2all_backend == "torch_all2allv"
...
class FusedMoEConfig:
    ...
    def use_torch_all2allv_kernels(self):
        """Use torch.distributed.all_to_all_single backend for EP communication."""
        return self.moe_parallel_config.use_torch_all2allv_kernels
