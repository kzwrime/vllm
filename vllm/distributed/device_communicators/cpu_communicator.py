...
class CpuCommunicator(DeviceCommunicatorBase):
    def __init__(
        ...
        if self.use_all2all:
            if self.all2all_backend == "torch_all2allv":  # type: ignore[has-type]
                from .all2all import All2AllSingleManager

                self.all2all_manager = All2AllSingleManager(self.cpu_group)
