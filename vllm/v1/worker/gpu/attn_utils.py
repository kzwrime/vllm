...
def _reshape_kv_cache(
    ...
    for kv_cache_group_spec in kv_cache_config.kv_cache_groups:
        for layer_name in kv_cache_group_spec.layer_names:
            ...
            layer_specs[layer_name] = kv_cache_spec
    ...
    if has_attn and has_mamba:
        _update_hybrid_attention_mamba_layout(kv_caches, layer_specs)
    return kv_caches
...
def _update_hybrid_attention_mamba_layout(
    ...
    """
    Update attention layer views from (2, num_blocks, ...) storage semantics to
    (num_blocks, 2, ...) storage semantics for hybrid attention + mamba models.

    Keep this in sync with GPUModelRunner._update_hybrid_attention_mamba_layout
