...
class WorkerProc:
    ...
    def __init__(
        ...
        #     vllm_config=vllm_config, MULTIMODAL_REGISTRY, shared_worker_lock)
    ...
    def make_worker_process(
        ...
        logger.info(
            ...
            rank, world_size, display_ip, port)

        conn, addr = server_socket.accept()
        logger.info("Accepted connection from worker rank %d at %s", rank,
                    str(addr))
